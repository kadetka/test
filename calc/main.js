...
class Calculator 
{
    constructor(container_id)
    {
        ...
        this.num1       = new Input({ event:{type:'oninput', callback: this.resultOperation}, class:'form-control', type:'number', placeholder:'input number a'});
        this.num2       = new Input({ event:{type:'oninput', callback: this.resultOperation}, class:'form-control', type:'number', placeholder:'input number b'});
        this.res        = new Input({class:'form-control', type:'number'});
        this.op         = new Select({event:{type:'onchange', callback: this.resultOperation}, class:'form-control', placeholder:'select operations'});
        this.resOp = 0;
